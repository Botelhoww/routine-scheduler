  ...
  return (
    <section className="mb-3">
      ...
      <button
        ...
        onClick={() => setOpen(v => !v)}
        aria-expanded={open}
        className="sticky top-[92px] z-10 w-full h-7 flex items-center gap-2 px-3 bg-[hsl(var(--surface-muted))] border-y border-border text-left hover:bg-muted transition-colors"
      >
        <ChevronRight
